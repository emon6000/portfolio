export const portfolioData = {
  professionalProjects: [
    ...
    },
    {
      ...
      tech: 'React',
      description:
        'A fast, interactive React application that uses the public GitHub API to search for developers and display their profile information along with their most recently updated repositories.',
      details:
        'This project was built from scratch to solidify foundational React concepts, specifically focusing on state management, side effects, and component-based architecture.',
      image:
  ...
  archives: [
      ...
      items: [
        {
          ...
          backDescription: 'A chaotic yet beautiful blend of history and hyper-growth.',
        },
        {
          id: 2,
        ...
        },
        {
          ...
          backDescription: 'Crystal clear blue waters and serene tropical vibes.',
        },
        {
          id: 4,
          ...
          backDescription: 'Rolling green hills covered in endless, tranquil tea estates.',
        },
        {
          id: 5,
          ...
          backDescription: 'Majestic peaks, clouds, and rich indigenous culture.',
        },
        {
          id: 6,
          ...
          backDescription: 'A thrilling hike leading to breathtaking coastal and mountain views.',
        },
        {
          id: 7,
          frontTitle: 'Kuakata',
          ...
          backDescription: 'A rare panoramic beach offering views of both the sunrise and sunset.',
        },
        {
          id: 8,
          frontTitle: 'Barishal',
          ...
          backDescription: 'The Venice of the East, famous for its lush floating markets.',
        },
        {
          id: 9,
          frontTitle: 'Cumilla',
          ...
          backDescription: 'Rich in history, ancient archaeological ruins, and cultural legacy.',
        },
        {
          id: 10,
          frontTitle: 'Chandpur',
        ...
        },
        {
          ...
          backDescription: 'Expansive coastal landscapes and peaceful rural life.',
        },
        {
          id: 12,
    ...
    },
    {
      ...
      items: [
        { id: 1, title: 'Cristiano Ronaldo', genre: 'Football' },
        { id: 2, title: 'Virat Kohli', genre: 'Cricket' },
        { id: 3, title: 'Lionel Messi', genre: 'Football' },
        { id: 4, title: 'Shakib Al Hasan', genre: 'Cricket' },
        { id: 5, title: 'Jude Bellingham', genre: 'Football' },
      ],
    },
    {
      id: 'actors',
